...
@Component({
  selector: 'app-view-public-complains',
  templateUrl: './view-public-complains.component.html',
  styleUrls: ['./view-public-complains.component.scss']
})
export class ViewPublicComplainsComponent implements OnInit {
  ...
  starRating:number=0;
    ...
    getAllComplaints(): void {
          this.citizenService.getAllComplaints() .subscribe(data => {
