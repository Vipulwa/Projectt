...
report(departmentName:string,status:string,from:string,to:string):Observable<IComplaint>{

  return this.httpClient.get<IComplaint>(this.url+"/complaintsDates",{
    params: {
...
getDepartmentnameList():Observable<IComplaint>{
  
  return this.httpClient.get<IComplaint>(this.url+"/department-names")
}
reportByDepartmentName():Observable<IComplaint>{

  return this.httpClient.get<IComplaint>(this.url+"/departmentreports")
}
