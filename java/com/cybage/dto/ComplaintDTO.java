...
public class ComplaintDTO {
	...
	public ComplaintDTO(int id, String subject, String complain, LocalDate createDate, LocalDate closeDate,
			String status, int userId, String username, String departmentName, List<Comment> comment)
	{
		super();
		this.id = id;
