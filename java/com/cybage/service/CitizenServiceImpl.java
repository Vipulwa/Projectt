...
public class CitizenServiceImpl implements ICitizenService{
	...
	@Override
	public String makeComplain(ComplaintDTO complaintDTO) {
	...
	@Override
	public Optional<Complaint> getComplaintById(int complainId) {
		
		return complaintRepository.findById(complainId);
	}
